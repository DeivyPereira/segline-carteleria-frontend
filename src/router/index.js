...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      { path: 'list', component: () => import('@/views/users/list'), name: 'Usuarios', meta: { title: 'Usuarios', icon: 'list',  roles: ['Administrador'] }},
  ...
  },
  {
    ...
    children: [
      { path: 'create', component: () => import('@/views/transferencia/create'), name: 'Crear Template', meta: { title: 'Crear Template',  roles: ['Administrador','Trabajador','Verificador de Depositos'] , noCache: true } },
      { path: 'edit/:id(\\d+)', component: () => import('@/views/transferencia/edit'), name: 'Editar Template', meta: { title: 'Editar Template',  roles: ['Administrador'] , noCache: true }, hidden: true },
      { path: 'ver/:id(\\d+)', component: () => import('@/views/transferencia/ver'), name: 'Ver Template', meta: { title: 'Ver Template',  roles: ['Administrador','Trabajador','Gestor','Visualizador de Transferencia', 'Comisionista','Verificador de Depositos'] , noCache: true }, hidden: true },
      { path: 'list', component: () => import('@/views/transferencia/list'), name: 'Template', meta: {  title: 'Template', icon: 'component' ,  roles: ['Administrador','Trabajador','Gestor','Visualizador de Transferencia', 'Comisionista','Verificador de Depositos'] }}
    ]
  },
  {
    path: '/bank',
